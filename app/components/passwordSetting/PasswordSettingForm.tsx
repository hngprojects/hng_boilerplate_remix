      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          {displayRequiremenList && (
            <>
              <div className="flex gap-4">
                <span
                  className={`h-[3px] w-[100px] ${caseIsValid ? "bg-success" : "bg-input"}`}
                ></span>
                <span
                  className={`h-[3px] w-[100px] ${numberInclude ? "bg-success" : "bg-input"}`}
                ></span>
                <span
                  className={`h-[3px] w-[100px] ${stringIsValid ? "bg-success" : "bg-input"}`}
                ></span>
              </div>
              <ul className="flex flex-col gap-2 py-6">
                ...
                <li className="flex items-center gap-2">
                  <span>
                    <CheckCircle2
                      className={`${caseIsValid ? "text-success" : "text-input"}`}
                    />
                  </span>
                ...
                <li className="flex items-center gap-2">
                  <span>
                    <CheckCircle2
                      className={`${numberInclude ? "text-success" : "text-input"}`}
                    />
                  </span>
                ...
                <li className="flex items-center gap-2">
                  <span>
                    <CheckCircle2
                      className={`${stringIsValid ? "text-success" : "text-input"}`}
                    />
                  </span>
          ...
          {passwordMatch ? (
            ...
            <p className="py-4 text-error">Passwords do not match</p>
          )}
        </div>
        <div className="flex items-center gap-6">
          <Link to={"/"}>
            <Button className="rounded-md border border-ring bg-transparent px-4 py-2 text-default">
              Cancel
            </Button>
          </Link>
          <AlertDialog>
